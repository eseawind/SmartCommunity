...
var roomNo = 0;
        ...
        $(document).ready(function () {
            ...
            $("#owner_table tbody").on("dblclick", "tr", function (event) {
                ...
                var roomnumber = $(this).children("td:eq(3)").text();
                roomnumber = roomnumber + "-" + name;
                //window.open('ownerState.html?name=' +name+'&&roomnumber='+roomnumber);
                window.location.href ='ownerState.html?roomnumber='+roomnumber;
            });
            ...
            $("#query_button").click(function () {
                ...
                alert(type + " " + buildNo + " " + unitNo + " " + roomNo);
                getQueryData();
            });
        });
...
function getOwnerData() {
    ...
    getDataWithFileUpload(requestOwnerMsg);
}
